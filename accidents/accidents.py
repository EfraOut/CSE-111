...
def main():
    ...
    # Prompt the user for a filename and open that text file.
        ...
        print(not_found_err)
        print('Please select other file')
    ...
    with open(filename, "rt") as text_file:
        ...
        while perc_reduc < 0:
            print(f'Error: {perc_reduc} is too low. Please enter a valid number')
            perc_reduc = float(input(
                "Percent reduction of texting while driving [0, 100]: "))
        while perc_reduc > 100:
            print(f'Error: {perc_reduc} is too high. Please enter a valid number')
            perc_reduc = float(input(
                "Percent reduction of texting while driving [0, 100]: "))
